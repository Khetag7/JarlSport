...
import { girlsProducts } from '@/data/girlGoodsProps';

const debouncedSearchQuery = ref('');
const productData = ref(girlsProducts || []) // Предполагаем, что products - это массив
...
<template>
    <section class="girlsGoods">
        <div class="girlsGoods__container">
            <h2 class="girlsGoods__title">Товары для девушек</h2>
            <div class="girlsGoods__wrap">
                <CatalogSort 
                ...
                <BurgerCatalog menu-text="Товары для девушек"/>
            </div>
