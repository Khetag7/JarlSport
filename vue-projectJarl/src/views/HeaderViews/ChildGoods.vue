...
import { childProducts } from '@/data/childProps';

const debouncedSearchQuery = ref('');
const productData = ref(childProducts || []) // Предполагаем, что products - это массив
...
<template>
    <section class="childGoods">
        <div class="childGoods__container">
            <h2 class="childGoods__title">Детские товары</h2>
            <div class="childGoods__wrap">
                <CatalogSort 
                ...
                <BurgerCatalog menu-text="Детские товары"/>
            </div>
