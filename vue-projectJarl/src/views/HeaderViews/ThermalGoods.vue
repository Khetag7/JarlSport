...
import { thermalProducts } from '@/data/thermalProps';

const debouncedSearchQuery = ref('');
const productData = ref(thermalProducts || []) // Предполагаем, что products - это массив
...
<template>
    <section class="thermalGoods">
        <div class="thermalGoods__container">
            <h2 class="thermalGoods__title">Термобелье</h2>
            <div class="thermalGoods__wrap">
                <CatalogSort 
                ...
                <BurgerCatalog menu-text="Термобелье"/>
            </div>
